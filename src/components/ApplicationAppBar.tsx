...
export interface ApplicationAppBarProps {
  // Add any props you want to pass to the ApplicationAppBar component
  pages: AppBarPage[]
  profileActions: AppBarNamedAction[]
}

export interface AppBarNamedAction {
  name: string
  action: () => void
}
...
function ApplicationAppBar(props: ApplicationAppBarProps) {
  ...
  const handleNavigateToPage = (link: string) => {
    navigate(link)
    handleCloseNavMenu()
  }
          ...
          <Box sx={{ flexGrow: 1, display: { xs: 'flex', md: 'none' } }}>
            ...
            >
              {props.pages.map((page) => (
                <MenuItem key={page.name} onClick={() => handleNavigateToPage(page.link)}>
